...
class AddBikeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveBtn.setOnClickListener {
            ...
            //val bikePicDrawable = bikePicture.drawable as BitmapDrawable?
            //val bikeBitmap = bikePicDrawable?.bitmap

            Log.d("AddBikeActivity", "dodatooooooo")
            val bikePicDrawable = bikePicture.drawable
            val bikeBitmap = if (bikePicDrawable is BitmapDrawable) {
                bikePicDrawable.bitmap
            } else {
                // Handle the case where bikePicture is not a BitmapDrawable
                null
            }
